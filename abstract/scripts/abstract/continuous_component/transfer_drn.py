...
def main(args):
    ...
    pre_conv = builds.DRN.PRE_CONV
    blocks, post_conv = builds.DRN.get_build(args.drn_cap)
    ...
    # setup environment
    env = ContinuousComponent(NUM_BLOCKS, args.num_pucks, args.num_pucks, NUM_ACTIONS)

...
def main(args):
    ...
    env = ContinuousTwoStacks(
        args.num_blocks, args.num_pucks + args.num_redundant_pucks, args.num_pucks // 2, args.num_actions
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Learn to build two equal stacks of pucks with a fully-convolutionaltu DQN agent.")
